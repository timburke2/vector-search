...
def full_eval(qrel_file, result_binary):
    """
    ...
    MRR, and MAP, and displays them in a table.
...
def plot_skijump(qrel_file, result_binary, k=5):
    """
    ...
    and generates a bar plot to visualize the distribution.
